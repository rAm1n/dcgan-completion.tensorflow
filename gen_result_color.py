...
from model_color import DCGAN
from utils import pp, visualize, to_json

import tensorflow as tf

flags = tf.app.flags
flags.DEFINE_integer("epoch", 24, "Epoch to train [25]")
...
flags.DEFINE_string("checkpoint_dir", "check_color", "Directory name to save the checkpoints [checkpoint]")
...
with tf.Session(config=config) as sess:
    ...
    for i in range(200):
   	 dcgan.generate_result(FLAGS, 16)
